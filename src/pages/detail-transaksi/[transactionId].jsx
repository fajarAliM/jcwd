...
const DetailTransaksiPage = () => {
  ...
  return (
    <Page title={`Detail Transaction (id: ${transactionId})`}>
      <Container
        sx={{
          mt: "56px",
          display: "flex",
        ...
        <Stack sx={{ width: "800px" }}>
          ...
          <Collapse in={bca}>
            ...
            >
              ...
              <Typography>
                3. Masukkan 5 angka kode perusahaan (80777) dan Nomor HP yang
                kamu daftarkan di akun (Contoh: 80777081316951940).
              </Typography>
              <Typography>
              ...
              <Typography>
                6. Jika sudah benar, klik Ya. Simpan struk transaksi sebagai
                bukti pembayaran.
              </Typography>
            </Stack>
          </Collapse>
